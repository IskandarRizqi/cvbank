    ...
    <div class="layout-px-spacing">
        ...
        <div class="page-header">
            <div class="page-title">
                ...
                <a href="{{route('pengalamanbank.create')}}" class="btn btn-primary btn-sm">Tambah</a>
                        ...
                        <table id="zero-config" class="table dt-table-hover" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$value->tanggungjawab}}</td>
                                    <td>{{$value->prestasi}}</td>
                                    <td>{{$value->penghargaan}}</td>
                                    <td>{{$value->omset}}</td>

                                    <td>
                                        <a href="{{ route('pengalamanbank.show', $value->id) }}" class="btn btn-primary btn-sm d-block d-none">Edit</a>
                                        <br>
