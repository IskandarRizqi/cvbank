...
<div id="content" class="main-content">
    <div class="layout-px-spacing">
        <form action="{{route('pengalamanumum.store')}}" method="POST" style="width: 1340px; height: 2000px;">
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-12 ">
                    <h5 class= "font-weight-bold " style="color: blue;" >Riwayat Non Perbankan </h5>
                        ...
                        <div class="widget-two">
                            ...
                            <div class="row m-2">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="hidden" name="idpengalamanumum" value="">
                            ...
                            <div class="row m-2">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <input type="hidden" name="idpenghargaan" value="">
