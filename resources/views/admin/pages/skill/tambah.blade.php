...
<div id="content" class="main-content">
    <div class="layout-px-spacing">
        <form action="{{route('skill.store')}}"  method="POST" style="width: 1340px; height: 2000px;">
                        ...
                        <div class="widget-two">
                            ...
                            <div class="row m-1">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <select name="bidang" class="form-control  basic  @error('bidang') is-invalid @enderror">
                                        @if(isset($ktg))
                                        @foreach($ktg as $val)
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <select name="bagian" class="form-control  basic  @error('bagian') is-invalid @enderror">
                                        @if(isset($ktg))
                                        @foreach($ktg as $val)
                                        <option value="{{$val}}">{{$val}}</option>
                                        @endforeach
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="text" name="ahli" class="form-control @error('ahli') is-invalid @enderror" placeholder="" value="{{old('ahli')}}">
                                    @error('ahli')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
